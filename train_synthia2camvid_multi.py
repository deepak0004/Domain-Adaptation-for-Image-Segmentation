...
IGNORE_LABEL = 255
INPUT_SIZE = '1280,720'
DATA_DIRECTORY_TARGET = './camvid'
DATA_LIST_PATH_TARGET = './dataset/camvid_list/train.txt'
INPUT_SIZE_TARGET = '960,720'
...
SNAPSHOT_DIR = './snapshots/snapshots_synthia_camvid/'
WEIGHT_DECAY = 0.0005
