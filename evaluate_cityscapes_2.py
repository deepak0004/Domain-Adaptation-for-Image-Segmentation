...
DATA_DIRECTORY = "./Cityscape/"
DATA_LIST_PATH = "./dataset/cityscapes_list/val.txt"
SAVE_PATH = './result/cityscapes_lambda'

IGNORE_LABEL = 255
NUM_CLASSES = 19
NUM_STEPS = 500 # Number of images in the validation set.
RESTORE_FROM = "./weights/GTA2Cityscapes_multi-ed35151c.pth"
RESTORE_FROM = "./snapshotslamda/GTA5_2000.pth"
#RESTORE_FROM = "./snapshots_deepak_single/GTA5_20000.pth"
SET = 'val'
