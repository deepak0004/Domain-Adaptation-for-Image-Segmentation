...
DATA_DIRECTORY = "./Cityscape/" #"./GTA5/"
DATA_LIST_PATH = "./dataset/cityscapes_list/val.txt" #"./dataset/gta5_list/train.txt"
SAVE_PATH = './result/cityscapes_sourceonly'

IGNORE_LABEL = 255
NUM_CLASSES = 19
NUM_STEPS = 500 # Number of images in the validation set.
RESTORE_FROM = "./weights/GTA2Cityscapes_multi-ed35151c.pth"
RESTORE_FROM = "./snapshots_sourceonly/GTA5_1500.pth"
SET = 'val'
...
def main():
    ...
    testloader = data.DataLoader(cityscapesDataSet(args.data_dir, args.data_list, crop_size=(1024, 512), mean=IMG_MEAN, scale=False, mirror=False, set=args.set), batch_size=1, shuffle=False, pin_memory=True)
